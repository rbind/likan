...
- Part I. The brain regions affording Language
  - Chapter 01. Language Functions in the Brain
    ...
    - Section 3. From Word Form to Syntactic and Lexical-Semantic Infor- mation [<i class="far fa-file-pdf"> \faFilePdf[regular] </i>](https://appendix.likan.info/Introduction-to-Neurolinguistics/CH_01_3.pdf)
    ...
    - Section 5. Syntactic Relations during Sentence Processing
