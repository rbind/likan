...
- Thi calss intends to provide a coherent view on the relation between language and the brain based on the multifold empirical data coming from different research fields: elec- trophysiological and functional neuroimaging data of the adult language system, neurosci- entific data of the developmental language system, and data on the brain structure and its maturation in humans as well as in non-human primates.
