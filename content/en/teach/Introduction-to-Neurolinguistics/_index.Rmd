...
- Part I. The brain regions affording Language
  - Chapter 01. Language Functions in the Brain
    - Section 1: [<i class="far fa-file-pdf"> \faFilePdf[regular] </i>](https://appendix.likan.info/Introduction-to-Neurolinguistics/CH_01_1.pdf)
    - Section 2: [<i class="far fa-file-pdf"> \faFilePdf[regular] </i>](https://appendix.likan.info/Introduction-to-Neurolinguistics/CH_01_2.pdf)
    - Section 3: [<i class="far fa-file-pdf"> \faFilePdf[regular] </i>](https://appendix.likan.info/Introduction-to-Neurolinguistics/CH_01_3.pdf)
    - Section 4: [<i class="far fa-file-pdf"> \faFilePdf[regular] </i>](https://appendix.likan.info/Introduction-to-Neurolinguistics/CH_01_4.pdf)
