...
- Location: Room 401, Yifu Teaching Building
...
- Part I. Background and methods
  - Chapter 00. Introduction to the Course. <i class="fa fa-file-pdf-o">  [Slides](https://appendix.likan.info/CognNeuroSci/CH.00.pdf)</i>
  - Chapter 01. A Brief History of Cognitive Neuroscience. <i class="fa fa-file-pdf-o">  [Slides](https://appendix.likan.info/CognNeuroSci/CH.01.pdf)</i>
  ...
  - Chapter 03. Methods of Cognitive Neuroscience. <i class="fa fa-file-pdf-o">  [Slides](https://appendix.likan.info/CognNeuroSci/CH.03.pdf)</i>
- Part II. Core Processes
  - Chapter 04. Hemispheric Specialization. <i class="fa fa-file-pdf-o">  [Slides](https://appendix.likan.info/CognNeuroSci/CH.04.pdf)</i>
