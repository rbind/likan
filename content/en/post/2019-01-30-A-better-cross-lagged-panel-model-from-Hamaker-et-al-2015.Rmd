...
author: "Likan Zhan"
date: "`r Sys.Date()`"
bibliography: [./2019-01-30-A-better-cross-lagged-panel-model-from-Hamaker-et-al-2015-appendixes/bibliography.bib]
link-citations: yes
csl: [./2019-01-30-A-better-cross-lagged-panel-model-from-Hamaker-et-al-2015-appendixes/apa-old-doi-prefix.csl]
output:
  html_document:
    toc: true
---

> **NOTE**: This post is copied from John C. Flournoy's post [A better cross-lagged panel model, from Hamaker et al. (2015)](https://jflournoy.github.io/2017/10/20/riclpm-lavaan-demo/#hamaker_critique_2015) with minor modifications. Copyright belongs to the orginal author.
...
This post summarizes critiques of the traditional cross-lagged panel model (CLPM), and an improved model by Hamaker, Kuiper, and Grasman @RN417.
...
![RI-CLPM Diagram](../2019-01-30-A-better-cross-lagged-panel-model-from-Hamaker-et-al-2015-appendixes/hamaker-diagram.png)
...
> If it is positive, it implies that occasions on which a person scored above his or her expected score are likely to be followed by occasions on which he or she still scores above the expected score again, and conversely. [@RN417, p. 104]
...
Now, we need some data. I'm using a data set presented on at a methods symposium at SRCD in 1997. Supporting documentation can be found [in this pdf](srcdmeth.pdf). Data and code for importing it was helpfully provided by [Sanjay Srivastava](http://twitter.com/hardsci).
...
> However, we can make use of the fact that the regular chi-square difference test is conservative in this context, meaning that, if it is significant, we are certain that the correct (i.e., chi-bar-square difference) test will be significant too. [@RN417, p. 105]
...
expected score again, and vice versa. [@RN417, pp. 104-105]
...
from a substantive viewpoint. [@RN417, p. 105]
