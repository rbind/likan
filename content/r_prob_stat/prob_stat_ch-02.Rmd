...
```{r label = "Figure_02_06", eval = TRUE, results = "hold", warning = FALSE}
stripchart(
  NYYHR,
...
```{r label = "Figure_02_07", eval = TRUE, results = "hold", warning = FALSE}
...
```{r label = "Figure_02_08", eval = TRUE, results = "hold", warning = FALSE}
